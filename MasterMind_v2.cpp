...
//Вывод правил игры в трех пунктах
void Rules()
{
    cout << "Правила вкратце:" << endl
        << "- Компьютер загадывает N-значное число из неповторяющихся цифр." << endl
        << "- После каждой правильной попытки ввода числа на экране отображается подсказка." << endl
        << "- Задача игрока - за M попыток отгадать число." << endl << endl;
}
